...
-- Insert único para as mat�rias-primas
...
-- Composição do produto 'Caixa de papel�o laminado super resistente' 
...
-- Composição do produto 'Embalagem pl�stica para alimentos' (IdProduto = 3)
INSERT INTO [dbo].[Composicao]	(IdProduto, IdMateriaPrima, Quantidade) 
VALUES 
...
-- Etapas de produção para 'Embalagem pl�stica para alimentos' (IdProduto = 3)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) 
VALUES
...
-- Etapas de produção para 'Envelope de papel para correspond�ncia' (IdProduto = 5)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) 
VALUES
...
INSERT INTO [dbo].[MovimentacaoEstoqueProduto]	(IdEstoqueProduto, idTipoMovimentacao, DataMovimentacao, Quantidade) 
VALUES 
												(3, 2, '30-05-2024', 250); -- Saída de produto