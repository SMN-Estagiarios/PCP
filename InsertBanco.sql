...
INSERT INTO [dbo].[Pedido]	(IdCliente, DataPedido, DataPromessa, DataEntrega)
	VALUES	(1, '2024-01-20', '2024-01-28', '2024-01-30'), -- Primeiro Pedido do cliente João Silva mês de janeiro concluido
...
INSERT INTO [dbo].[Pedido] (IdCliente, DataPedido, DataPromessa, DataEntrega)
	VALUES	(1, '2024-01-20', '2024-01-28', '2024-01-30'), -- Primeiro Pedido do cliente joão silva mês de janeiro concluído
...
INSERT INTO [dbo].[Produto] (Nome) 
	VALUES	('Caixa de papelão laminado super resistente'),
...
INSERT INTO [dbo].[Composicao]	(IdProduto, IdMateriaPrima, Quantidade) 
	VALUES	(2, 4, 200), -- Papel kraft reciclado
...
INSERT INTO [dbo].[Composicao]	(IdProduto, IdMateriaPrima, Quantidade) 
	VALUES	(3, 6, 500), -- Plástico (polietileno de alta densidade)
...
INSERT INTO [dbo].[Composicao]	(IdProduto, IdMateriaPrima, Quantidade) 
	VALUES	(6, 13, 1500), -- Plástico PET (polietileno tereftalato)
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(8, 27, 800),  -- Plástico biodegradável
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(9, 6, 500),   -- Plástico (polietileno de alta densidade)
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(11, 11, 300),  -- Papel sulfite
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(14, 4, 200),  -- Papel kraft reciclado
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(15, 6, 500),   -- Plástico (polietileno de alta densidade)
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(17, 11, 200),  -- Papel sulfite
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(20, 28, 500),  -- Tecido não tecido
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(21, 20, 600),  -- Papelão ondulado
    		(21, 1, 400),   -- Papelão
    		(21, 2, 30);    -- Cola
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(23, 11, 300),  -- Papel sulfite
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(26, 4, 300),  -- Papel kraft reciclado
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(27, 27, 500),  -- Plástico biodegradável
...
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(29, 4, 200),  -- Papel kraft reciclado
    		(29, 12, 10);  -- Adesivo para selagem
GO

-- Composição do produto 'Garrafa PET reciclada' (IdProduto = 30)
INSERT INTO [dbo].[Composicao] (IdProduto, IdMateriaPrima, Quantidade)
	VALUES	(30, 13, 1200), -- Plástico PET (polietileno tereftalato)
...
INSERT INTO [dbo].[EstoqueProduto]	(IdProduto, QuantidadeFisica, QuantidadeMinima) 
	VALUES	(1, 150, 100), -- Caixa de papelão laminado super resistente
...
INSERT INTO [dbo].[TipoMovimentacao]	(Id, Nome) 
	VALUES	(1, 'Entrada'),          -- Movimentação de entrada de estoque
...
INSERT INTO [dbo].[PedidoProduto]	(IdPedido, IdProduto, Quantidade) 
	VALUES	(1, 1, 50),  -- Primeiro Pedido do cliente João Silva - Caixa de papelão laminado super resistente
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(7, 'Corte do papelão ondulado', 75, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(8, 'Corte do material biodegradável', 60, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(9, 'Extrusão do plástico', 120, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(10, 'Fabricação do vidro', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(11, 'Corte do papel kraft e papelão', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(12, 'Fabricação do vidro', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(13, 'Corte e dobra do papelão', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(14, 'Corte do papel e da alça', 60, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(15, 'Extrusão do plástico', 120, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(16, 'Fabricação do vidro', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(17, 'Corte e dobra do papel kraft especial', 75, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(18, 'Moldagem e prensagem do alumínio', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(19, 'Corte e dobra do papelão especial', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(20, 'Corte e costura do tecido', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(21, 'Corte e dobra do papelão especial', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(22, 'Fabricação do vidro decorativo', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(23, 'Corte e dobra do papel kraft', 75, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(24, 'Fabricação do vidro', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(25, 'Corte e dobra do papelão especial', 90, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(26, 'Corte e dobra do papel', 60, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(27, 'Extrusão do plástico biodegradável', 120, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(28, 'Fabricação do vidro', 180, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(29, 'Corte e dobra do papel kraft', 75, 1),
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao, NumeroEtapa) 
	VALUES	(30, 'Reciclagem do plástico PET', 120, 1),
