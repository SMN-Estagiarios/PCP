INSERT INTO [dbo].[Cliente] (Nome) VALUES 
							('João Silva'),
							('Maria Oliveira'),
							('Carlos Souza');
GO
...
INSERT INTO [dbo].[Produto] (Nome) VALUES 
...
INSERT INTO [dbo].[MateriaPrima]	(Nome) VALUES 
									('Papelão'),
									('Cola'),
									('Laminação'),
...
INSERT INTO [dbo].[Composicao]	(IdProduto, IdMateriaPrima, Quantidade) VALUES 
								(1, 1, 1000), -- Papelão
								(1, 2, 50),  -- Cola
								(1, 3, 310);  -- Laminação
GO
...
INSERT INTO [dbo].[EstoqueProduto]	(IdProduto, QuantidadeFisica, QuantidadeMinima, QuantidadeVirtual) VALUES 
...
INSERT INTO [dbo].[EstoqueMateriaPrima] (IdMateriaPrima, QuantidadeFisica, QuantidadeMinima) VALUES
										(1, 5000, 1000), -- Papelão
										(2, 300, 50), -- Cola
										(3, 200, 50), -- Laminação
...
INSERT INTO [dbo].[PedidoProduto]	(IdPedido, IdProduto, Quantidade) VALUES
...
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(1, 'Corte do papelão', '01:00:00'),
									(1, 'Aplicação de cola e montagem', '02:00:00'),
									(1, 'Laminação e acabamento', '01:30:00');
GO

-- Etapas de produção para 'Sacola de papel kraft reciclado' (IdProduto = 2)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(2, 'Corte do papel kraft', '00:45:00'),
									(2, 'Montagem e colagem das alças', '01:00:00'),
									(2, 'Reforço e finalização', '00:30:00');
GO

-- Etapas de produção para 'Embalagem plástica para alimentos' (IdProduto = 3)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(3, 'Extrusão do plástico', '02:00:00'),
									(3, 'Corte e moldagem', '01:30:00'),
									(3, 'Selagem térmica', '01:00:00');
GO

-- Etapas de produção para 'Pote de vidro para conservas' (IdProduto = 4)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(4, 'Fabricação do vidro', '03:00:00'),
									(4, 'Moldagem e resfriamento', '02:00:00'),
									(4, 'Aplicação da tampa e vedante', '00:45:00');
GO

-- Etapas de produção para 'Envelope de papel para correspondência' (IdProduto = 5)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(5, 'Corte do papel sulfite', '00:30:00'),
									(5, 'Dobra e montagem', '00:45:00'),
									(5, 'Aplicação do adesivo de selagem', '00:15:00');
GO

-- Etapas de produção para 'Garrafa PET para bebidas' (IdProduto = 6)
INSERT INTO [dbo].[EtapaProducao]	(IdProduto, Descricao, Duracao) VALUES
									(6, 'Fabricação do plástico PET', '02:30:00'),
									(6, 'Sopro e moldagem da garrafa', '01:45:00'),
									(6, 'Aplicação da tampa de rosca', '00:30:00');
GO 

-- Primeiro Pedido do cliente João Silva - Caixa de papelão laminado super resistente
INSERT INTO [dbo].[MovimentacaoEstoqueProduto]	(IdEstoqueProduto, idTipoMovimentacao, DataMovimentacao, Quantidade) VALUES 
